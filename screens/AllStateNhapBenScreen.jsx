...
function AllStateNhapBenScreen({ navigation, route }) {
    ...
    const [thuGonThongTinNhapBen, setThuGonThongTinNhapBen] = useState(false)
        ...
        <View style={{ flex: 1, paddingHorizontal: 12 }}>
            ...
            <ScrollView
                ...
                >
                    ...
                    <Image source={icons.fill} style={{ width: 8, height: 6, marginLeft: 5, marginTop: 21, transform: [{ rotate: '270deg' }] }} />
                </TouchableOpacity>

                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }}
                    onPress={() => setThuGonTatCa(!thuGonTatCa)}
                >
                    <Text style={{ color: '#005F94', fontSize: 16, fontWeight: 'bold', marginTop: 20 }}>II. THÔNG TIN NHẬP BẾN</Text>
                ...
                </TouchableOpacity>
                {
                    !thuGonTatCa && (
                        <View>
                            {/* Vị trì */}
                            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }}
                                onPress={() => setThuGonViTri(!thuGonViTri)}
                            >
                            ...
                            {
                                (item.tinhtrang === 'Chờ xác nhận nhập bến' || item.tinhtrang === 'Không được nhập bến' || item.tinhtrang === 'Trong bờ') && (
                                    <View style={{ marginTop: 20 }}>
                                        <TouchableOpacity style={{
                                            ...
                                            paddingVertical: 12,
                                            opacity: item.tinhtrang === 'Trong bờ' ? 1 : 0.4
                                        }}
                                            onPress={() => navigation.navigate('PhieuThongBaoNhapBen')}
                                            disabled={item.tinhtrang === 'Trong bờ' ? false : true}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <Image source={icons.docs} style={{ width: 15, height: 20 }} />
                                                <Text style={{ color: 'white', fontWeight: 'bold', marginLeft: 6 }}>Phiếu thông báo tàu cá nhập cảng</Text>
                                            </View>
                                        ...
                                        <TouchableOpacity style={{
                                            ...
                                            onPress={() => navigation.navigate('BienBanKiemTraTauNhapBen')}
                                            disabled={item.tinhtrang === 'Trong bờ' ? false : true}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <Image source={icons.docs} style={{ width: 15, height: 20 }} />
                                                <Text style={{ color: 'white', fontWeight: 'bold', marginLeft: 6 }}>Biên bảng nhập bến</Text>
                                            </View>
                                            <Image source={icons.back} style={{ tintColor: 'white', height: 12, width: 12, alignSelf: 'center', transform: [{ scaleX: -1 }] }} />
                                        </TouchableOpacity>
                                    </View>
                            ...
                            {/* Không được nhập bến */}
                            {
                                item.tinhtrang === 'Không được nhập bến' && (
                                    <View>
                                        <Text style={styles.type}>Từ chối nhập bến</Text>
                            ...
                            {/* đã duyệt nhập bến nên sẽ đang TRONG BỜ */}
                            {
                                item.tinhtrang === 'Trong bờ' && (
                                    <View>
                                        {/* Thông tin nhập bến------------------------------------------------------------------------------------- */}
                                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }}
                                            onPress={() => setThuGonThongTinNhapBen(!thuGonThongTinNhapBen)}>
                                            <Text style={styles.type}>Thông tin nhập bến</Text>
                                            <Image source={icons.fill} style={{ width: 8, height: 6, marginLeft: 5, marginTop: 8 }} />
                                        </TouchableOpacity>
                                        {
                                            !thuGonThongTinNhapBen && (
                                                <View>
                                                    <View>
                                                        <View style={[styles.childContainer, { flexDirection: 'column' }]}>
                                                            ...
                                                            <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 10, marginTop: 20 }}>
                                                                <TouchableOpacity style={styles.touchableCheckBoxChecked}
                                                                ...
                                                                <Text style={{ color: 'black', fontSize: 16 }}>Xác nhận nhập bên</Text>
                                                            </View>
                                                        </View>
...
export default AllStateNhapBenScreen