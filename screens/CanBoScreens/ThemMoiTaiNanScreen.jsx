...
function ThemMoiTaiNanScreen({ navigation }) {
        ...
        <View style={{ flex: 1, paddingHorizontal: 12 }}>
            ...
            <View style={{ marginBottom: 17, marginTop: 5 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 5 }}>
                    ...
                    <Text style={{ fontSize: 16, color: 'black', fontWeight: 'bold' }}>Thêm mới tai nạn</Text>
            ...
            <ScrollView
                ...
                {/* ô 2 */}
                <Text style={{ color: '#3345CB', fontSize: 16, fontWeight: 700, marginTop: 20 }}>Thiệt hại về người</Text>
                <View style={{ borderRadius: 6, backgroundColor: 'white', paddingTop: 20, paddingBottom: 20, paddingHorizontal: 12, marginTop: 10 }}>
                    ...
                    <MyTextInput
                        header={'Số người mất tích'}
                        type={'delete'}
                        editable={true}
                    />
                    <MyTextInput
                        header={'Số người bị thương'}
                        type={'delete'}
                        editable={true}
                        value={'3'}
                    />
                ...
                <View style={{ backgroundColor: 'white', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 15 }}>
                    <MyCheckBox text={'Chìm'} state={true} />
                    <MyTextInput editable={true} header={'Thông tin chìm'} type={'delete'} />
                </View>

                <View style={{ backgroundColor: 'white', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 15, marginTop: 5 }}>
                    <MyCheckBox text={'Hỏng'} />
                </View>

                <View style={{ backgroundColor: 'white', borderRadius: 6, paddingHorizontal: 12, paddingVertical: 15, marginTop: 5 }}>
                    <MyCheckBox text={'Thiệt hại'} state={false} />
                </View>


                {/* ô 4 */}
                <Text style={{ color: '#3345CB', fontSize: 16, fontWeight: 700, marginTop: 20 }}>Đơn vị xử lý</Text>
                <View style={{ borderRadius: 6, backgroundColor: 'white', paddingTop: 20, paddingBottom: 20, paddingHorizontal: 12, marginTop: 10 }}>
                ...
                <View style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: '#454545' }}>
                    ...
                    <View style={{ backgroundColor: 'white', borderTopEndRadius: 15, borderTopStartRadius: 15 }}>
                        <View style={{ paddingHorizontal: 12, paddingBottom: 37, paddingTop: 30 }}>
                            <Text style={{ textAlign: 'center', fontSize: 18, fontWeight: 'bold', color: 'black' }}>Xác nhận thêm tai nạn</Text>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => navigation.navigate('CBDanhSachTaiNan')}
                                >
...
export default ThemMoiTaiNanScreen